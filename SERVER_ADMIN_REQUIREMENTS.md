...
|---|---|---|---|
| 관리자 인증/권한 | mock 및 기존 JWT 사용 | 역할·권한 저장 구조 필요 | P0 |
| 관리자 대시보드 | mock 구현 | API 필요 | P0 |
| 매장 승인 목록/상세 | mock 구현 | API 및 테이블 필요 | P0 |
| 승인/보류/반려 | mock 구현 | 변경 API, 감사 로그, 알림 필요 | P0 |
...
5. 프론트 mock API를 실제 API adapter로 전환한다.
